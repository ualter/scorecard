...
public class AnalisadorExtratoCCDeutscheGUI extends AbstractDialog implements MouseListener, ActionListener, FocusListener {
	...
	public AnalisadorExtratoCCDeutscheGUI(JFrame owner) {
        ...
        this.modelTabNaoEncontrados = new DefaultModelLinhaExtrato(null,new Object[]{"Data Operação","Data Valor","Histórico","Valor","Saldo","Tipo","C.Contabil","Object" });
	...
	private class Salvar extends SwingWorker<String, String> {
		...
		private String tipo;
		public Salvar(AnalisadorExtratoCCDeutscheGUI frame, LinhaExtratoContaCorrenteDeutsche linha, Conta conta, ContaCorrente cc,ScorecardBusinessDelegate businessDelegate,String tipo) {
			this.frame = frame;
			this.linha = linha;
			this.conta = conta;
			this.cc = cc;
		...
		protected String doInBackground() throws Exception {
			if ( "Transferência".equalsIgnoreCase(tipo) ) {
				...
				transferencia.setAtivoTransferido(getContaCorrenteAlvoTransferencia(), 
						  						  getContaContabilDeposito(),Deposito.class,"Depósito Deutsche");

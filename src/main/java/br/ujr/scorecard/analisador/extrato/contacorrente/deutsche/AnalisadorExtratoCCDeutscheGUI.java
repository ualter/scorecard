...
public class AnalisadorExtratoCCDeutscheGUI extends AbstractDialog implements MouseListener, ActionListener, FocusListener {
	...
	public AnalisadorExtratoCCDeutscheGUI(JFrame owner) {
		...
		jScrollPaneTabNaoEncontrados.setBounds(10, 70, 1209, 430);
		...
		lblLctoNaoEncontrados.setBounds(150, 10, 1007, 55);
		
		JLabel logoBanco = new JLabel(new ImageIcon(Util.loadImage(this, "deutsche_bank_logo.png")));
		logoBanco.setBounds(1165, 12, 48, 48);
		...
		panelBtn.setBounds(10, 510, 1209, 100);
	...
	private void layOutTableNaoEncontrados() {
		...
		vlr.add("Débito");
		vlr.add("Depósito");
		vlr.add("Transferência");
		vlr.add("Investimento");
		vlr.add("Estipêndios");
		valoresCombos = new String[vlr.size()];
		vlr.toArray(valoresCombos);
